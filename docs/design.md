...
/handoff [--model provider/model-id[:thinking]] [scope]
  ...
  │
  ├─ GATE A     BLUF + definition of done + height-budgeted prompt preview + model + rationale
